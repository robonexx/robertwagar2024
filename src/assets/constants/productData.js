...
export const productData = [
  ...
  },
  {
    ...
    year: '2023',
    tag: '#website #design',
    tech: 'Next, Supabase, sass, tiptap, swr',
    desc: 'A blog project done with next js, using supabase was the backend',
    id: 4,
    image: IMG8,
    github: 'https://github.com/robonexx/stories/',
    demo: 'https://vercel.com/robonexx/stories',
  },
  {
    title: 'Hype in to health',
    year: '2023',
    tag: '#website #api',
    tech: 'React, vite, typescript, tailwind, ',
    desc: 'A simple project i did while practicing, my coding skills, typescript and functionality, for people who wanna start training, and need some inspiration',
    id: 4,
    image: IMG7,
    github: 'https://github.com/robonexx/hypeintohealth',
    demo: 'https://hypeintohealth.vercel.app/',
  },
  {
    title: 'VGA',
    year: '2022',
